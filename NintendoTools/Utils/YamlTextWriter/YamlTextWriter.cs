...
internal sealed class YamlTextWriter : IDisposable
{
    ...
    #region constructor
    public YamlTextWriter(TextWriter writer) => _writer = writer;
    #endregion
    ...
    public void WritePropertyName(string name)
    {
        ...
        if (_firstDictInArray) _writer.Write(SafePropertyName(name) + ":");
        else _writer.Write(GetIndent() + SafePropertyName(name) + ":");
    ...
    private void InternalWriteValue(string value)
    {
        switch (_stateStack.Peek())
        {
            ...
            case WriterState.Array:
                if (_firstArrayInArray) _writer.Write(" -");
                else _writer.Write(GetIndent() + "-");
                break;
            case WriterState.Property:
                _stateStack.Pop();
                break;
